            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                ...
                <nav className="cs_nav">
                  ...
                  >
                    <li className="">
                      <Link href="/home-v2">Accueil</Link>
      ...
      <div className={`cs_sidenav ${sideNav ? 'active' : ''}`}>
        ...
        <div className="cs_sidenav_in">
          ...
          <div className="cs_logo_box">
            <Image src='/images/ocr4labs-logo.png' alt="Logo" height={28} width={173} />
            <div className="cs_height_15" />
            <h3 className="cs_fs_24 cs_semibold mb-0">
              Votre allié pour une prescription sans erreur
            </h3>
          </div>
          ...
          <IconBoxStyle11
            title="Téléphone"
            subTitle="+33 1 88 80 26 96"
            iconSrc="/images/contact/icon_1.svg"
          />
          <Spacing md="30" lg="30" xl="30" />
          <IconBoxStyle11
            title="Email"
            subTitle="contact@ocr4labs.com"
            iconSrc="/images/contact/icon_2.svg"
          />
          <Spacing md="30" lg="30" xl="30" />
          <IconBoxStyle11
            title="Addresse"
            subTitle="73 Rue de Vaugirard, 750006 Paris, FRANCE "
