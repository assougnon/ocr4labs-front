...
const Login = ({ mode }: { mode: SystemMode }) => {
  ...
  useEffect(() => {
    if (session) {
      // Rediriger vers la page cible après login
  ...
  const {
    ...
    handleSubmit,
    formState: { errors }
  } = useForm<FormData>({ resolver: valibotResolver(schema) })
  ...
  return <div className='flex bs-full justify-center'>
    <div
      ...
      <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-8 sm:mbs-11 md:mbs-0'>
        ...
        >
          ...
          <Button
            ...
            onClick={() =>
              signIn('google', {
                callbackUrl: searchParams.get('redirectTo') ?? '/home'
              })
            }
          >
            Sign in with Google
